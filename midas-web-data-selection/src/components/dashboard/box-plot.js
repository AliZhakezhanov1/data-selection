...
export const Boxplot = ({ data  , labelx , labely}) => {
  function BoxPlot(
    data,
    {
      ...
      fill = "steelblue", // fill color of boxes
    ...
    if (yDomain === undefined)
      yDomain = [d3.min(B, (d) => d.range[0]), d3.max(B, (d) => d.range[1])];

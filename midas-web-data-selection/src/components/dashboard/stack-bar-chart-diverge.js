...
export const StackBarDiverge = ({ data }) => {
const rulings = ['happy' , 'sad' , 'anger' , 'excite']
function StackedBarChart(data, {
    ...
    const svg = d3.select("#stack-bar-diverge")
        .attr("width", width)
        .attr("height", height)
  ...
  const draw = async (data) => {
    const chart = StackedBarChart(data, {
      ...
      z: (d) => d.ruling,
      xFormat: "+%",
      xLabel: "← more sad · Credibility · more trust →",
      ...
      zDomain: rulings,
      colors: d3.schemeSpectral[rulings.length],
      width:620,
      marginLeft: 120,
    });
  };
